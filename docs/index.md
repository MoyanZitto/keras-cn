...
[<font color='#FF0000'>一些基本概念</font>](getting_started/concepts)中提到的概念应该是你在使用Keras之前应该了解的。除此之外，我们从[<font color='#FF0000'>keras.io</font>](http://blog.keras.io/)和其他地方选择了一些文章，翻译在栏目“深度学习与Keras”中。该栏目的位置是左侧导航栏中的最下方，欢迎各位同学阅读和提出意见。
