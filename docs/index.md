...
[<font color='#FF0000'>一些基本概念</font>](getting_started/concepts)中提到的概念应该是你在使用Keras之前应该了解的。除此之外，我们从[<font color='#FF0000'>blog.keras.io</font>](blog.keras.io)和其他地方选择了一些文章，翻译在栏目“深度学习与Keras”中。该栏目的位置是左侧导航栏中的最下方，欢迎各位同学阅读和提出意见。

所有的文章均在醒目位置标志标明来源与作者，本网站无任何盈利目的，对该栏目文章的原文也不具有任何处置权。如您仍觉不妥，请联系本人（moyan_work@foxmail.com）删除。
